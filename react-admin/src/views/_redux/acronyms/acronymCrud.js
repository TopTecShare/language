...
export const UNI_URL = `${API_URL}/acronym`;

export function addAcronym(product) {
...
export function getAcronymLists() {
...
export function updateAcronym(data) {
...
export function deleteAcronym(id) {
